...
public class SeTIChatConversationActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		myfilter.addAction("es.uc3m.SeTIChat.CHAT_MESSAGE_TO_CHAT");
		
		receiver=new BroadcastReceiver(){

			//what will you do when intent triggers?
			@Override
			public void onReceive(Context arg0, Intent arg1) {
				
//				/refesh the convewrsation view
				text.setText(text.getText()+"\n"+arg1.getCharSequenceExtra("message"));
