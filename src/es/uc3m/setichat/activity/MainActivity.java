		 ...
		 openReceiver = new BroadcastReceiver() {
		  ...
		  chatMessageReceiver = new BroadcastReceiver() {
			   ...
			   */
			    	...
			    	/*instead of show a toast we define a new intentso the
			    	 *  ConversationActivity could catch the messages too
			    	 */
			    	String intentKey = "es.uc3m.SeTIChat.CHAT_MESSAGE_TO_CHAT";
					Intent onMessageIntent = new Intent(intentKey);
					onMessageIntent.setPackage("es.uc3m.setichat");
					onMessageIntent.putExtra("message", intent.getCharSequenceExtra("message"));
					context1 = getApplicationContext();
					context.sendBroadcast(onMessageIntent);  
